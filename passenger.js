...
$(".room-plus").click(function() {
    ...
    var newValue = parseInt(input.val(), 10) + 1;
    input.val(Math.min(newValue, max));
    updateRoom(this, 1, max, input2, 'show', input3, 0);
});
$(".room-minus").click(function() {
    ...
    updateRoom(this, 0, min, input2, 'hide', input2, total_pax);
});

function updateRoom(obj, e, minmax, objinput, sh, objinput2, total_pax) {
    // alert(objinput2);
    var tot_pax = $(obj).parents().find("#noOfPassengers").val();
    var newValue = parseInt(objinput, 10) + parseInt(e, 10);
